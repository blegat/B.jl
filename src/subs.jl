...
#_substype{T}(Tuple{<:AbstractVariable, T}) = T
#_substype{T}(Tuple{<:AbstractVariable, T}) = T
_substype{T}(s::MP.AbstractSubstitution{T}) = T
_substype(s1::MP.AbstractSubstitution, s2::MP.AbstractSubstitution...) = promote_type(_substype(s1), _subtype(s2...))
